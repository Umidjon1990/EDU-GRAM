...
export const groupManagementDictionary = {
  ...
  telegramAutoHelp:
    "Qo'lda yozish shart emas: avval botga Telegramda /start yozing, keyin shu yerda Chat IDni topish tugmasini bosing.",
  telegramTokenHelp: "BotFather bergan tokenni kiriting.",
  telegramChatIdHelp:
    "Bot o'ziga xabar yubora olmaydi; u shaxsiy chat yoki guruh manziliga yuboradi.",
...
export const assignmentDictionary = {
  ...
  maxAttachmentCountHint: "Rasm, audio, video yoki fayl javobida nechta bo'lak yuborilishini belgilang.",
  ...
  createdAt: "Yaratilgan sana",
  assignmentsCount: "topshiriq",
  fullCompleted: "To'liq bajargan",
  partialCompleted: "Qisman bajargan",
  notStarted: "Boshlamagan",
  lessonProgress: "Dars progressi",
